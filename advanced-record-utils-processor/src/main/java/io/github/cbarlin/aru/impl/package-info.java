 ...
 * </ul>
 * <p>
 * This package is sub-divided into the different things that the processor can do, and a "Constants" file.
 * <p>
 * Note that this maven project isn't a module - that's because the `module-info` file would very unwieldy given the sheer number
