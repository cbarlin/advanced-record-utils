...
public final class WriteBoxedNumerics extends NonCollectionXmlVisitor {
    ...
    public WriteBoxedNumerics(final XmlRecordHolder xmlRecordHolder, final XmlElementPrism prism, final Optional<AnalysedOptionalComponent> analysedOptionalComponent) {
    ...
    protected boolean writeElementMethod(final AnalysedComponent analysedComponent) {
        if (BOXED_NUMERICS.contains(analysedComponent.serialisedTypeName())) {
