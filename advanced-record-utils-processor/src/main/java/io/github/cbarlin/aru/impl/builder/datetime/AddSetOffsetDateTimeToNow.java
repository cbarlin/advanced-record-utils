...
public final class AddSetOffsetDateTimeToNow extends SetToNow {
    public AddSetOffsetDateTimeToNow(final AnalysedRecord analysedRecord, final BuilderClass builderClass) {
        super(analysedRecord, Names.OFFSET_DATE_TIME, builderClass);
    }
}
