...
public record NullableAutoCollectionHandler(
    ...
    public void addField(final ToBeBuilt addFieldTo) {
        handler.addNullableAutoField(component, addFieldTo, component.unNestedPrimaryTypeName());
    }

    @Override
    public void writeGetter(final MethodSpec.Builder methodBuilder) {
        handler.writeNullableAutoGetter(component, methodBuilder, component.unNestedPrimaryTypeName());
    }
    ...
    public void writeAddSingle(final MethodSpec.Builder methodBuilder) {
        handler.writeNullableAutoAddSingle(component, methodBuilder, component.unNestedPrimaryTypeName());
    }
    ...
    @Override
    public void writeAddMany(final BuilderClass builderClass, final String singleAdderName, final String addAllMethodName, AruVisitor<?> visitor) {
