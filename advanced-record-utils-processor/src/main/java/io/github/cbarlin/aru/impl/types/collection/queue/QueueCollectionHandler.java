...
public abstract class QueueCollectionHandler extends StandardCollectionHandler {
    protected QueueCollectionHandler(final ClassName classNameOnComponent, final ClassName mutableClassName, final ClassName immutableClassName) {
    ...
    public void addDiffRecordComponents(final TypeName innerType, final ToBeBuiltRecord recordBuilder) {
        final ParameterizedTypeName paramTypeName = ParameterizedTypeName.get(LIST, innerType);
    ...
    public void writeDifferMethod(final TypeName innerType, final MethodSpec.Builder methodBuilder, final ClassName collectionResultRecord) {
        ...
        final ParameterizedTypeName listPtn = ParameterizedTypeName.get(QUEUE, innerType);
        ...
        methodBuilder.addModifiers(Modifier.FINAL, Modifier.STATIC)
             ...
             .addStatement("final $T added = new $T<>()", listPtn, LINKED_LIST)
             .addStatement("final $T removed = new $T<>()", listPtn, LINKED_LIST)
             .addStatement("final $T common = new $T<>()", listPtn, LINKED_LIST)
