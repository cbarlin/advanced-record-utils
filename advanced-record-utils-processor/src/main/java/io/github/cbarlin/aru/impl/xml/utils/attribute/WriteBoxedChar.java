...
public final class WriteBoxedChar extends WriteXmlAttribute {

    private static final TypeName TN = TypeName.CHAR.box();

    public WriteBoxedChar(final XmlRecordHolder xmlRecordHolder, final XmlAttributePrism xmlAttributePrism, final Optional<TypeAliasComponent> typeAliasComponent) {
