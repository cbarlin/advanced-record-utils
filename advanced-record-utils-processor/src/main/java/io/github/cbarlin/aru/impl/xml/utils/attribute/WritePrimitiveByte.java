...
public final class WritePrimitiveByte extends WriteXmlAttribute {
    ...
    public WritePrimitiveByte(final XmlRecordHolder xmlRecordHolder, final XmlAttributePrism xmlAttributePrism, final Optional<TypeAliasComponent> typeAliasComponent) {
