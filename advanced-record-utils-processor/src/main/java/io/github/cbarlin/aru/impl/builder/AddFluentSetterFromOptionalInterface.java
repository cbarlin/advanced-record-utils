...
@RequiresBean({ConstructorComponent.class, ComponentTargetingInterface.class, AnalysedOptionalComponent.class})
public final class AddFluentSetterFromOptionalInterface extends RecordVisitor {

    private final ComponentTargetingInterface cti;
    private final BuilderClass builder;

    public AddFluentSetterFromOptionalInterface(final ComponentTargetingInterface cti, final BuilderClass builderClass) {
