...
public final class WriteEnum extends XmlVisitor {
    ...
    protected boolean visitComponentImpl(final AnalysedComponent analysedComponent) {
        if(!OptionalClassDetector.checkSameOrSubType(component.unNestedPrimaryTypeName(), ENUM)) {
            return false;
        }
        ...
        component.withinUnwrapped(
            ...
            methodBuilder,
            "val",
            component.unNestedPrimaryTypeName()
        );
