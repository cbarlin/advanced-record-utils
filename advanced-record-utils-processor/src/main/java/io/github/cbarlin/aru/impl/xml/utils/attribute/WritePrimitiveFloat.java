...
public final class WritePrimitiveFloat extends WriteXmlAttribute {

    public WritePrimitiveFloat(final XmlRecordHolder xmlRecordHolder, final XmlAttributePrism xmlAttributePrism, final Optional<TypeAliasComponent> typeAliasComponent) {
