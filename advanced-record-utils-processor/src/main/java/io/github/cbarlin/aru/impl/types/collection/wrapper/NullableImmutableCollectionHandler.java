...
public record NullableImmutableCollectionHandler(
    ...
    public void addField(final ToBeBuilt addFieldTo) {
        handler.addNullableImmutableField(component, addFieldTo, component.unNestedPrimaryTypeName());
    }

    @Override
    public void writeGetter(final MethodSpec.Builder methodBuilder) {
        handler.writeNullableImmutableGetter(component, methodBuilder, component.unNestedPrimaryTypeName());
    }
    ...
    public void writeAddSingle(final MethodSpec.Builder methodBuilder) {
        handler.writeNullableImmutableAddSingle(component, methodBuilder, component.unNestedPrimaryTypeName());
    }
