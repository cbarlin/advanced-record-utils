...
public final class WriteBoxedBoolean extends WriteXmlAttribute {

    private static final TypeName TN = TypeName.BOOLEAN.box();

    public WriteBoxedBoolean(final XmlRecordHolder xmlRecordHolder, final XmlAttributePrism xmlAttributePrism, final Optional<TypeAliasComponent> typeAliasComponent) {
