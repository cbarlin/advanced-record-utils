...
public final class AddOtherBuilderFromRecord extends RecordVisitor {

    private final ComponentTargetingRecord cti;
    private final BuilderClass builder;

    public AddOtherBuilderFromRecord(final ComponentTargetingRecord cti, final BuilderClass builderClass) {
