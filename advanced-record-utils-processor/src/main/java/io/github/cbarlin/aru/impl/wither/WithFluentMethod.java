...
public final class WithFluentMethod extends WitherVisitor {
    ...
    public WithFluentMethod(final WitherInterface witherInterface, final AnalysedRecord analysedRecord, final ComponentTargetingRecord componentTargetingRecord) {
