...
public final class WritePrimitiveLong extends WriteXmlAttribute {

    public WritePrimitiveLong(final XmlRecordHolder xmlRecordHolder, final XmlAttributePrism xmlAttributePrism, final Optional<TypeAliasComponent> typeAliasComponent) {
