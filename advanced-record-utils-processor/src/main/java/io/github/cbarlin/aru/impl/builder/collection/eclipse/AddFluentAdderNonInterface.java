...
@ServiceProvider
public final class AddFluentAdderNonInterface extends EclipseComponentVisitor {
    ...
    @Override
    public boolean innerVisitComponent(EclipseCollectionComponent analysedComponent) {
    ...
    private boolean supportedComponent(final EclipseCollectionComponent analysedComponent) {
