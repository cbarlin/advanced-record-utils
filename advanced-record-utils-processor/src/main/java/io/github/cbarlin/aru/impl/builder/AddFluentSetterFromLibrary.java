...
public final class AddFluentSetterFromLibrary extends RecordVisitor {

    private final ComponentTargetingLibraryLoaded cti;
    private final BuilderClass builder;

    public AddFluentSetterFromLibrary(final ComponentTargetingLibraryLoaded cti, final BuilderClass builderClass) {
