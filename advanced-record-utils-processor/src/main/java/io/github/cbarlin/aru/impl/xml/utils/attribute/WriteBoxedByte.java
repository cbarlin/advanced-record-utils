...
public final class WriteBoxedByte extends WriteXmlAttribute {
    ...
    public WriteBoxedByte(final XmlRecordHolder xmlRecordHolder, final XmlAttributePrism xmlAttributePrism, final Optional<TypeAliasComponent> typeAliasComponent) {
