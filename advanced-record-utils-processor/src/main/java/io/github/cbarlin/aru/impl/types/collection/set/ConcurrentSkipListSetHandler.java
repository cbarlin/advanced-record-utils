...
@Component
@GlobalScope
public final class ConcurrentSkipListSetHandler extends SetCollectionHandler {
    private static final ClassName CLASS_NAME = ClassName.get("java.util.concurrent", "ConcurrentSkipListSet");
