...
public final class WithAdd extends WitherVisitor {

    public WithAdd(final WitherInterface witherInterface, final AnalysedRecord analysedRecord) {
        super(Constants.Claims.WITHER_WITH_ADD, witherInterface, analysedRecord);
    }
