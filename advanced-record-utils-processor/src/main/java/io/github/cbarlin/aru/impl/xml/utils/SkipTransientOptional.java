...
@RequiresBean({XmlTransientPrism.class, AnalysedOptionalComponent.class})
public final class SkipTransientOptional extends XmlVisitor {
    ...
    public SkipTransientOptional(final XmlRecordHolder xmlRecordHolder) {
