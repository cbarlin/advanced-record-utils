...
public final class WriteOffsetDatetime extends NonCollectionXmlVisitor {
    ...
    public WriteOffsetDatetime(final XmlRecordHolder xmlRecordHolder, final XmlElementPrism prism, final Optional<AnalysedOptionalComponent> analysedOptionalComponent) {
    ...
    protected boolean writeElementMethod(final AnalysedComponent analysedComponent) {
        if ( OFFSET_DATE_TIME.equals(analysedComponent.serialisedTypeName())) {
            // Nice!
