...
Particularly useful on large trees of records, as the <<#use-cascading,cascading>> effect means you do not have to annotate each record. The processor also adds the import annotation on the `+*Utils+` classes for sealed interfaces.
