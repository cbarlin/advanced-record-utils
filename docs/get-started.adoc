...
* https://labs.carrotsearch.com/hppc.html[HPPC: High Performance Primitive Collections for Java^] - List/Set Collections from HPPC are detected if referenced and handled appropriately (e.g. creating `+CharArrayList+` if requested).
