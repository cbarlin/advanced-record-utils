...
public sealed interface AnalysedComponent permits BasicAnalysedComponent, DelegatingComponent {
    ...
    List<AnalysedTypeConverter> converters();

    <T> Optional<T> findPrism(final ClassName annotationClassName, final Class<T> prismClass);
    ...
    default boolean isPrismPresent(final ClassName annotationClassName, final Class<?> prismClass) {
