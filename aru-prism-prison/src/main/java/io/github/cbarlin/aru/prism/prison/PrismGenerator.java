...
// This file exists to cause prisms of common annotations to be generated
//  We can then publish the prisms as a library and not depend on the actual libraries
//  when running the actual processor
