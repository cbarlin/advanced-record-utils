...
public class WriteCharSequence extends XmlVisitor {
    ...
    protected boolean visitComponentImpl(final AnalysedComponent analysedComponent) {
        ...
        if (optPrism.isPresent() && APContext.types().isSubtype(analysedComponent.componentType(), APContext.elements().getTypeElement(CharSequence.class.getCanonicalName()).asType())) {
            // Nice!
